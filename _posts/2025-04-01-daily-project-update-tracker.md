---
layout: post
title: My Daily Project Update Tracker That Actually Works
subtitle: How one end-of-day logging habit and a Notion Button improved my daily standups and reviews
...
![My Daily Project Update Tracker That Actually Works](/assets/img/graphics/20250101-update-tracker/20250401-daily-update-tracker-1.png)  
_One end-of-day logging habit to improve daily standups and reviews_   
...
![Template button for daily entry](/assets/img/graphics/20250101-update-tracker/20250401-daily-update-tracker-3.gif)  
_Template button for daily entry to make your standup updates easier_
...
![Yesterday's Updates, Today's Plan and Blockers](/assets/img/graphics/20250101-update-tracker/20250401-daily-update-tracker-4.gif)   
_Add Yesterday's Updates, Today's Plan and Blockers to follow standard DSU format_
...
![A lightweight, easy-to-maintain to-do list for action items](/assets/img/graphics/20250101-update-tracker/20250401-daily-update-tracker-5.gif)  
_A lightweight, easy-to-maintain to-do list for action items_
...
![Did something noteworthy?](/assets/img/graphics/20250101-update-tracker/20250401-daily-update-tracker-6.gif)  
_Did something noteworthy? Note down anything worth remembering_
...
![Tomorrow's update ready within minutes](/assets/img/graphics/20250101-update-tracker/20250401-daily-update-tracker-7.gif)  
_Tomorrow's update ready within minutes_
...
Here’s what my setup includes:
  ...
  * A template button that adds a new entry
![A template button that adds a new entry](/assets/img/graphics/20250101-update-tracker/20250401-daily-update-tracker-8.gif)  

  * The default title of the entry is the current date of the entry creation
![Button actions](/assets/img/graphics/20250101-update-tracker/20250401-daily-update-tracker-9.gif)  
