...
Years ago, I ran into an early-day video from Ryder Caroll, the founder of the [Bullet Journal Method](https://www.youtube.com/@bulletjournal){:target="_blank"}. 
...
![](/assets/img/260112-bujo-index-1.png){:.center-image}
...
![](/assets/img/260112-bujo-spread-1.png){:.center-image}
_A weekly spread - looking messy, but it captured one of my busiest & productive weeks_

This experience has taught me two important things:  

1. Not everything has to be improved, especially when it is already working.  
2. It doesn’t need to look perfect. Sometimes, just getting the job done in the most repeatable way is better.  
